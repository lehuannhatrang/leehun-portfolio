---
type: PostLayout
title: '[AIOps] OpsGentic: Bringing Autonomous AI Agents to Kubernetes Self-Healing'
date: '2026-06-23'
author: content/data/team/Le-Huan.json
excerpt: ''
featuredImage:
  type: ImageBlock
  url: /images/opsgentic-logo-compress.png
  altText: Post thumbnail image
  caption: Caption of the image
  elementId: ''
media:
  type: ImageBlock
  url: /images/overview-architecture.png
  altText: Post image
  caption: Caption of the image
  elementId: ''
bottomSections: []
...
backgroundImage:
  ...
  opacity: 100
metaTitle: 'Opsgentic: AI Agents for Kubernetes , AIops automation Devops'
metaDescription: >-
  An introduction to OpsGentic — an open-source toolkit leveraging LLMs and
  autonomous agentic workflows for automated Kubernetes troubleshooting,
  root-cause analysis, and safe remediation.
socialImage: /images/opsgentic-logo-compress.png
---
# OpsGentic: AI Agents That Turn Kubernetes Alerts into GitOps Pull Requests
...
**Option 1: Local (For testing the agent, no cluster needed):**
...
**Option 2: Kubernetes (full demo with ArgoCD, GitHub, Alertmanager webhook):**
